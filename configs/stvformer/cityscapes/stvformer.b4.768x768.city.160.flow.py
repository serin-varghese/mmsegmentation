_base_ = [
    '../../_base_/models/segformer.py', '../../_base_/default_runtime.py',
...
data_root = '/data/christoph/dataset/cityscapes'
img_norm_cfg = dict(
...
train_pipeline = [
    ...
    dict(type='LoadSequenceFromFile'),
    ...
    dict(type='Collect', keys=['img', 'gt_semantic_seg', 'seq', 'seq_flo']),
]
test_pipeline = [
    dict(type='LoadImageFromFile'),
    dict(type='LoadSequenceFromFile'),
